    ...
    def get_transform(self, transform_pipeline: str = "default"):
        ...
        if transform_pipeline == "default":
            ...
            xform = transforms.Compose([
                ...
                transforms.GaussianBlur(kernel_size=3),  # Gaussian blur for slight blurriness
                transforms.ToTensor(),
                transforms.Normalize(INPUT_MEAN, INPUT_STD)  # Normalize using the dataset's mean and std
            ])
