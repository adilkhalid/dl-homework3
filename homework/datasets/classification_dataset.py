    ...
    def get_transform(self, transform_pipeline: str = "default"):
        ...
        if transform_pipeline == "default":
            ...
            xform = transforms.Compose([
                transforms.ColorJitter(0.9, 0.9, 0.9, 0.1),  # Adjust brightness, contrast, saturation, hue
                transforms.RandomHorizontalFlip(),  # Randomly flip images horizontally
                transforms.ToTensor(),
                transforms.Normalize(INPUT_MEAN, INPUT_STD)  # Normalize using precomputed mean and std
            ])
